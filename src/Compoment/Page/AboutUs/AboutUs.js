    ...
    <div className="about-us">
      <Container>
        ...
        <Row className="about-content">
          ...
          <Col lg={6}>
          <p>
              Không gian của Cafe Bột được thiết kế nhẹ nhàng, tinh tế, tạo cảm giác
              như một ngôi nhà thứ hai cho những ai yêu thích không gian yên tĩnh, gần
              gũi. Bạn có thể đến đây để thưởng thức cà phê, làm việc, hoặc gặp gỡ bạn bè.
            </p> 
        ...
        <Row className="contact">
          <Col>
            ...
            <p>
              Bạn có câu hỏi hay cần hỗ trợ? Hãy liên hệ với chúng tôi qua các phương
              thức dưới đây:
            </p>
            <ul>
              <li>Email: Thangvuong843@gmail.com</li>
              <li>Điện thoại: 0387039792</li>
              <li>Địa chỉ: 119 số 23 phường 11 quận 6</li>
            </ul>
          </Col>
        </Row>
      </Container>
